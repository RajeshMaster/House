...
Date: 2020-12-11 18:10:42
*/

SET FOREIGN_KEY_CHECKS=0;
-- ----------------------------
-- Table structure for `hms_master_buildingname`
-- ----------------------------
DROP TABLE IF EXISTS `hms_master_buildingname`;
CREATE TABLE `hms_master_buildingname` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `orderId` int(11) NOT NULL,
  `buildingName` varchar(100) DEFAULT NULL,
  `buildOnDate` varchar(100) DEFAULT NULL,
...
-- ----------------------------
-- Records of hms_master_buildingname
-- ----------------------------
