...
<article id="bank" class="DEC_flex_wrapper" data-category="bank bank_sub_1">
	...
	{{ Form::open(array('name'=>'banklistview',
						 'id'=>'banklistview', 
						 'url' => 'Bank/listview?mainmenu='.$request->mainmenu.'&time='.date('YmdHis'), 
						 'method' => 'POST')) }}
	...
	{{ Form::hidden('pageview', 'banklistview' , array('id' => 'pageview')) }}
		...
		<div class="box100per tableShrink pt10 mnheight mb0">
			<table class="table-striped table footable table-bordered mt10 mb10" >
				...
				<tbody class="tablealternateclr">
					@php $tempBelongTo = ''; @endphp
					@forelse ($userBankDtls as $count => $data)
						@if($tempBelongTo != $data ->familyName)
							<tr>
								<th colspan="2" class="colschange" style="background-color: #c7e1f7;">
									@php $tempBelongTo = $data ->familyName; @endphp
									{{ $data ->familyName }}
								</th>
							</tr>
							<tr>
