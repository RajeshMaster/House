...
<article id="mail" class="DEC_flex_wrapper" data-category="mail mail_sub_1">
	<fieldset class="mt20">
		<div class="header">
			...
			<h2 class="pull-left h2cnt">{{trans('messages.lbl_mailcontaddedit')}}</h2>
	...
	<fieldset id="hdnfield" class="mt10">
		...
		<div class="col-xs-12 mt10">
			...
			<div class="col-xs-8 mw mailsubjecttextbox">
		...
		<div class="col-xs-12 mt10">
			...
			<div class="col-xs-7 mw mailcontenttextbox" style="">
